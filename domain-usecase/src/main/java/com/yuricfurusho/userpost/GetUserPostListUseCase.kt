...
import com.yuricfurusho.account.GetLoggedSessionApiKeyUseCase
...
//    private val userPostRepository: UserPostDummyRepository,
    private val getLoggedSessionApiKeyUseCase: GetLoggedSessionApiKeyUseCase,
    ...
    suspend operator fun invoke(): Flow<Result<List<UserPostItem>>> {
        val apiKey = getLoggedSessionApiKeyUseCase()

...
object DummyData {
    ...
    private val postFromClementine = PostItem(
    ...
    private val post1FromPatricia = PostItem(
    ...
    private val post2FromPatricia = PostItem(
        userAvatarUrl = "https://i.postimg.cc/brxW4LRj/patricia.png",
        userFullName = "Patricia Lebsack",
    ...
    private val postFromNicholas = PostItem(

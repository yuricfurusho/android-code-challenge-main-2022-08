...
object DummyUIData {
    ...
    private val userPostFromClementine = UserPostItemUI(
    ...
    private val userPost1FromPatricia = UserPostItemUI(
    ...
    private val userPost2FromPatricia = UserPostItemUI(
        userAvatarUrl = "https://i.postimg.cc/brxW4LRj/patricia.png",
        userFullName = "Patricia Lebsack",
    ...
    private val userPostFromNicholas = UserPostItemUI(
    ...
    val userPostItemUIList = mutableListOf<UserPostItemUI>()
        .apply {
